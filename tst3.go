...
func (self *State256_t) StateAdd(in byte) uint64 {
	self.a = (self.e + 1) % 256
	self.b = (self.state[self.a] + self.state[in]) % 256
	self.e = self.e ^ self.state[self.b]
	// self.e = ROL64(self.e, self.e%33+32, self.b, self.a)*(self.state[self.b]+1) + self.state[self.a]
	self.e = ROL64(self.e, self.e%63+2, self.b, self.a)*255 + self.state[self.b]
