...
func (self *State256_t) Uint64Next(in uint64) (ex uint64) {
	...
	in = in ^ (uint64(self.state[(begin+0)%256])<<(8*0) |
	...
	ex = in * (uint64(self.state[(begin+8)%256])<<(8*0) |
		uint64(self.state[(begin+9)%256])<<(8*1) |
		uint64(self.state[(begin+10)%256])<<(8*2) |
		uint64(self.state[(begin+11)%256])<<(8*3) |
		uint64(self.state[(begin+12)%256])<<(8*4) |
		uint64(self.state[(begin+13)%256])<<(8*5) |
		uint64(self.state[(begin+14)%256])<<(8*6) |
		uint64(self.state[(begin+15)%256])<<(8*7))
	return
}
